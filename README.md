...
```text
CareerLens/
├── AI_ENGINEER/                    # AI Service & Machine Learning Models
...
│   │   ├── losses.py
│   │   └── utils.py
│   ├── saved_model/                # Pre-trained Keras models
...
│   ├── notebooks/
│   │   └── CareerLens.ipynb
│   ├── logs/                       # TensorFlow event logs
│   ├── Dockerfile
│   ├── requirements.txt
│   └── README_AI.md
│
├── DATA_SCIENTIST/                 # Data Processing & Dashboard
...
│   └── data_dictionary.md
│
├── FS_WEB_DEV/                     # Frontend & Backend Web Application
│   ├── web-app/
...
│   │   │   └── README.md
│   │   │
│   │   └── frondend/               # React/Vite Frontend (note: folder name has typo)
│   │       ├── src/
│   │       ├── assets/
│   │       ├── index.html
│   │       ├── package.json
